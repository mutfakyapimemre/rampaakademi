			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-sortable="false" data-widget-deletebutton="false">
					<header>
						...
						<h2><?php echo count($get_categories).' kayıt bulundu'; ?> </h2>
					</header>
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								...
								<tbody>
									<?php foreach ($get_categories AS $category): ?>
									 <tr <?php if ($category -> category_status == 0) echo 'style="background-color: #E6E6E6;"'; ?>>
										<td>
											<?php echo $category -> category_id ?>	
										</td>
										<td>
											<?php
												if ($category -> category_cover_photo)
													echo '<img src="'.$category -> category_photo.'" width="70">';
												else
													echo 'Belirtilmedi';
											?>
										</td>
										...
										<td class="hidden-md hidden-sm hidden-xs">
											<?php echo $category -> category_link; ?>
										</td>
										<td class="hidden-md hidden-sm hidden-xs">
											<?php echo date('d/m/Y - H:i:s', $category -> category_create_time); ?>	
										</td>
										<td>
											<?php
											...
											<a rel="tooltip" data-placement="top" data-original-title="Önizle" href="<?php echo base_url($category -> category_link); ?>" target="_blank" class="label label-info">
												<i class="fa fa-eye"></i>
											</a>
										
											<a rel="tooltip" data-placement="top" data-original-title="Düzenle" href="<?php echo base_url('panel/kategoriler/kategori-duzenle/'.$category -> category_id); ?>" class="label label-primary">
												<i class="fa fa-edit"></i>
											</a>
										
											<a rel="tooltip" data-placement="top" data-original-title="Sil" data-toggle="modal" data-target="#delete<?php echo $category -> category_id; ?>" href="#" class="label label-danger">
												<i class="fa fa-trash-o"></i>
											</a>

											<div class="modal fade" id="delete<?php echo $category -> category_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url('panel/kategoriler/kategori-sil/'.$category -> category_id); ?>" class="label label-danger">
