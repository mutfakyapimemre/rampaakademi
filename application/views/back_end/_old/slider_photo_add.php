                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
                             ...
                             <div class="control-group">
                                <label class="control-label">Slayt Fotoğrafı (Web)*</label>
                                <div class="controls">
                                    <input type="file" class="span11" name="slider_add_photo" required="" />
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                <label class="control-label">Slayt Fotoğrafı (Mobil) *</label>
                                <div class="controls">
                                    <input type="file" class="span11" name="slider_add_photo_mobile" required="" />
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="slider_add_photo_link" class="span11">
                                </div>
                                <!-- controls -->
                            </div>
                            <!-- control-group -->
